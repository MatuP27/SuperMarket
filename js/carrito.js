...
let jackDaniels = new producto(3100, "Jack Daniels", "img/alcohol4.png", "Bebida alcohólica, prohibida su venta a menores de 18 años.", "alcohol");
...
let elemento = localStorage.getItem("productosEnCarrito");
...
function productosEnCarrito(){
    ...
    for (let indice of elemento) {
        ...
        resultado.innerHTML += `
            <div class="producto">
                <div class="arriba">
                    <div class="izquierda">
                        <a href="productos.html" onclick="creacionPagina('${indice}');" class="info">
                            <img src="${productos[indice].imagen}" height="250" width="200" alt="">
                        </a>
                        <a href="productos.html" onclick="creacionPagina('${indice}');" class="info">
                            <h3 id="nombreProducto">${productos[indice].nombre}</h3>
                        </a>
                    </div>

                    <div class="derecha">
                        <a href="productos.html" onclick="creacionPagina('${indice}');" class="info">
                            <h3>$${productos[indice].precio}</h3>
                        </a>
                    </div>
    ...
    resultado.innerHTML += `
        <div class="compra">
            <h4>Total: $${total}</h4>
            <div class="bottom">
                <div class="btn__group" id="agregarCarro">
                <a onclick="agragarAlCarrito();" class="btn addToCart">Comprar</a>
                </div>
            </div>
        </div>
        `
